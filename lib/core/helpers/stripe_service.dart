...
import 'package:challenge_diabetes/features/checkout_payment/data/models/payment_intent_model/payment_intent_model.dart';
...
class StripeService {
  ...
  Future<PaymentIntentModel?> createPaymentIntent(
    ...
    try {
      ...
      print('Payment amount: ${paymentIntentInputModel.amount} cents');
